...
export const LanguageProvider = ({ children }) => {
  ...
  const translations = {
    en: {
      ...
      heroDescription: "Experience the ultimate gaming universe with GAME STATION, featuring 100+ high quality, premium HTML5 games featuring Puuzzle, Sports and Adventure Enthusiasts.",
      playNow: "Play Now",
      about: "About Us",
    ...
    am: {
      ...
      heroDescription: "ከ 100 በላይ የ HTML አስደሳች እና አስቂኝ ጨዋታዎች በአንድ ቦታ በ GAME STATION የጨዋታ አለም ያግኙ።",
      playNow: "አሁኑኑ ይጫወቱ",
      about: "ስለ እኛ",
